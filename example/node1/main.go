...
func (s *Service1) OnInit() error {
	...
	s.AfterFunc(time.Second, "test2", func(timer *timingwheel.Timer, args ...interface{}) {
		//var out int
		//// 1. 固定参数->全部参数 (正常调用)
		//if err := s.SelectSameServer("", "Service2").Call("APIWithFixedParams", nil, []interface{}{1, 2}, &out); err != nil {
		...
		//if err := s.SelectSameServer("", "Service2").Call("APIWithFixedParams", nil, []interface{}{4}, &out); err != nil {
		//	log.SysLogger.Errorf("call Service2.APIWithFixedParams failed, err:%v", err)
		//}
		//log.SysLogger.Debugf("call Service2.APIWithFixedParams out2:%d", out)
		//
		//// 3. 固定参数->没有参数 (返回参数数量错误)
		//if err := s.SelectSameServer("", "Service2").Call("APIWithFixedParams", nil, nil, &out); err != nil {
		//	log.SysLogger.Errorf("call Service2.APIWithFixedParams failed, err:%v", err)
		//}
		//log.SysLogger.Debugf("call Service2.APIWithFixedParams out3:%d", out)
		//
		//// 4. 固定参数->全部参数,不接收返回值 (正常调用,out依然输出3)
		//if err := s.SelectSameServer("", "Service2").Call("APIWithFixedParams", nil, []interface{}{5, 6}, nil); err != nil {
		//	log.SysLogger.Errorf("call Service2.APIWithFixedParams failed, err:%v", err)
		//}
		//log.SysLogger.Debugf("call Service2.APIWithFixedParams out4:%d", out)

		// 5. 不固定参数->有固定参数和不定参和返回值 给出全部参数 (正常调用)
		//if err := s.SelectSameServer("", "Service2").Call("APIWithFixedAndIndefiniteParams", nil, []interface{}{7, 8, "9", "10"}, &out); err != nil {
		...
		//if err := s.SelectSameServer("", "Service2").Call("APIWithFixedAndIndefiniteParams", nil, []interface{}{11, 12}, &out); err != nil {
		//	log.SysLogger.Errorf("call Service2.APIWithFixedAndIndefiniteParams failed, err:%v", err)
		//}
		...
		//if err := s.SelectSameServer("", "Service2").Call("APIWithFixedAndIndefiniteParams", nil, []interface{}{13}, &out); err != nil {
		//	log.SysLogger.Errorf("call Service2.APIWithFixedAndIndefiniteParams failed, err:%v", err)
		//}
		//log.SysLogger.Debugf("call Service2.APIWithFixedAndIndefiniteParams out7:%d", out)
		//
		//// 8.  不固定参数->有固定参数和不定参和返回值 不给任何参数 (返回参数数量错误)
		//if err := s.SelectSameServer("", "Service2").Call("APIWithFixedAndIndefiniteParams", nil, nil, &out); err != nil {
		//	log.SysLogger.Errorf("call Service2.APIWithFixedAndIndefiniteParams failed, err:%v", err)
		//}
		...
		//if err := s.SelectSameServer("", "Service2").Call("APIWithFixedAndIndefiniteParams", nil, []interface{}{14, 15, "16", "17"}, nil); err != nil {
		//	log.SysLogger.Errorf("call Service2.APIWithFixedAndIndefiniteParams failed, err:%v", err)
		//}
		//log.SysLogger.Debugf("call Service2.APIWithFixedAndIndefiniteParams out8:%d", out)

		// 9. 没有参数-> 有返回值 (正常调用)
		//if err := s.SelectSameServer("", "Service2").Call("APIWithoutParams", nil, nil, &out); err != nil {
		...
		//if err := s.SelectSameServer("", "Service2").Call("APIWithoutParams", nil, 1, &out); err != nil {
		//	log.SysLogger.Errorf("call Service2.APIWithoutParams failed, err:%v", err)
		//}
		//log.SysLogger.Debugf("call Service2.APIWithoutParams out2:%d", out)
		//
		//// 11. 没有参数-> 没有返回值 (正常调用)
		//if err := s.SelectSameServer("", "Service2").Call("APIWithoutParams", nil, nil, nil); err != nil {
		//	log.SysLogger.Errorf("call Service2.APIWithoutParams failed, err:%v", err)
		//}
