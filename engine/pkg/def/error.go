...
var (
	...
	ErrMailboxWorkerUserChannelNotInit = errors.New("mailbox worker user channel not init")      // 邮箱工作通道未初始化
	ErrMailboxWorkerSysChannelNotInit  = errors.New("mailbox worker sys channel not init")       // 邮箱工作通道未初始化
